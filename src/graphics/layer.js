//CQ Graphics Library : low-level graphics drawing context
//cq (the constructor), 
//cq.Layer -- the drawing class, 
//cq.palettes -- colour palletes
//cq.Layer.prototype -- too big
...
(function() {
    ...
    cq.Layer.prototype = {
        ...
        update: function() {
            ...
            if (COCOONJS)
                Cocoon.Utils.setAntialias(smoothing);
            if (cq.strokeStyle)
